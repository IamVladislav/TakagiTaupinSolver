...
public:
    ...
    std::vector <Vector <double>> segment_lenght;
    double nu;
    ...
    void Model_Creation(std::vector <Vector<double>> direction_vector_list, std::vector <int> type_list);
    ...
    void Segment_Lenght(std::vector <double> segment_lenght);
};
